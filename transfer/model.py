...
class GINConv(MessagePassing):
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        # print(edge_index[0].type(torch.LongTensor))
        # print(edge_index[0].type(torch.LongTensor).dtype)
        # print(edge_index[0].shape) 
        # self.aggr, 
        return self.propagate(edge_index[0].long(), x=x, edge_attr=edge_embeddings)
